  ...
  return (
    <div>
      <header className="p-4 flex justify-between">
        ...
        <Link to={'/login'} className="flex items-center border border-gray-300 rounded-full px-4 py-2 gap-2 shadow-md shadow-gray-200">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <div className="bg-gray-500 rounded-full border border-gray-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
